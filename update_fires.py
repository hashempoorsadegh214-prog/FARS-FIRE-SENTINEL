...
def update_main_csv(
    ...
    # اگر داده امروز موجود نیست،
    # fires.csv قبلی حفظ شود
    existing =
        load_existing_csv(
            OUTPUT_FILE
        )
...
def main():
    ...
    # --------------------------------------------------------
    # update-info.json
    # فقط اگر حداقل یک سرویس FIRMS پاسخ داده باشد
    # --------------------------------------------------------
    ...
    if successful_sources > 0:
        ...
        print(
            "هیچ منبع FIRMS با موفقیت پاسخ نداد؛ "
            "زمان آخرین آپدیت تغییر نمی‌کند."
        )
